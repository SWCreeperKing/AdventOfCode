...
using static Backbone.ImguiKeyMapping;
...
public static partial class RlImgui
{
    ...
    public static int InitFontSize = 20;
    ...
    private static void EndInitImGui()
    {
        ...
        try
        {
            unsafe
            {
                ...
                {
                    CascadiaCode = GetIO().Fonts.AddFontFromMemoryTTF(new IntPtr(bytes), byteLength, InitFontSize);
                }
            }
        }
        catch (Exception e)
        ...
        unsafe
        {
            ...
            platformIo.Platform_SetClipboardTextFn = GetFunctionPointerForDelegate(setClip);
            platformIo.Platform_GetClipboardTextFn = GetFunctionPointerForDelegate(getClip);
        }
    ...
    public static byte[] LoadCascadiaCode(out int byteLength)
    {
        ...
        var stream =
            asm.GetManifestResourceStream("Backbone.Resources.AddedAssets.Font.CascadiaMono.ttf");
