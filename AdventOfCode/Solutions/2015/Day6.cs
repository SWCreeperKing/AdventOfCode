...
public class Day6 : Puzzle<(string Value, (int, int), (int, int))[], int>
{
    public static readonly Regex Reg =
        new(@"^((on|off)|toggle) ([0-9]{1,3}),([0-9]{1,3}) through ([0-9]{1,3}),([0-9]{1,3})$");
    ...
    public override int Part2((string Value, (int, int), (int, int))[] inp)
    {
        ...
        return lights.Cast<int>().Sum(b => b);
    }
}