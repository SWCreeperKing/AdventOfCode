...
namespace AdventOfCode.Solutions._2020
{
    public class eDay20
    {
        public class Tile
        {
            ...
            {
                // void FlipV(ref string[] t) => t = new[] { t[2], t[1].Reverse().ToS(), t[0], t[3].Reverse().ToS() };
                // void FlipH(ref string[] t) => t = new[] { t[0].Reverse().ToS(), t[3], t[2].Reverse().ToS(), t[1] };
        ...
        public static long Part1(string input)
        {
            ...
            Console.WriteLine($"{string.Join(",", tiles.Where(t => t.matched.Count(b => b) == 2).Select(t => t.id))}");
